...
System.out.println("Connected successfully");
	...
	//int res	= stmt.executeUpdate("insert into st values(5,'Mahesh',25000)");
		//if(res>0) {
		...
		PreparedStatement pstmt = con.prepareStatement("insert into st values(?,?,?)");
...
//		}
		...
		//PreparedStatement pstmt = con.prepareStatement("select * from st where income > ?");
		//System.out.println("Enter the salary");
		//float  income = obj.nextFloat();
